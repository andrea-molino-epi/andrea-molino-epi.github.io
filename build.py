...
def build_profile(profile: Dict[str, str]):
    ...
    profile_html += "If you're interested in a full list of my publications, you can find them on my "
    profile_html += '<a href="%s">Google Scholar</a>, ' % profile["scholar"]
    profile_html += '<a href="%s">NCBI Bibliography</a>, or below.' % profile["ncbi"]
    profile_html += "\n<p>I would love to connect! You can reach me at %s." % profile["email"]
